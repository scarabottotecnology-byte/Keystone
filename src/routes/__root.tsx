...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Controladoria estratégica, FP&A, gestão de custos e due diligence para empresas que decidem com o rigor de um conselho." },
      { name: "author", content: "Keystone" },
      { property: "og:title", content: "Keystone" },
      { property: "og:description", content: "Controladoria estratégica e FP&A para empresas que decidem com rigor de conselho." },
